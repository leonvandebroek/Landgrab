...
internal sealed class TestServiceFactory
{
    ...
    public GameplayService CreateGameplayService()
    {
        ...
        return new GameplayService(RoomProvider, gameStateService, winConditionService, new RoleProgressService(), new VisibilityService(), NullLogger<GameplayService>.Instance);
    }
}
