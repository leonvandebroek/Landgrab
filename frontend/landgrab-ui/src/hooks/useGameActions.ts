...
export function useGameActions(options: UseGameActionsOptions): UseGameActionsResult {
  ...
  return {
    ...
    handleActivateStealth: abilityActions.handleActivateStealth,
    handleActivateCommandoRaid: abilityActions.handleActivateCommandoRaid,
    handleAcceptDuel: abilityActions.handleAcceptDuel,
    handleDeclineDuel: abilityActions.handleDeclineDuel,
    handleDetainPlayer: abilityActions.handleDetainPlayer,
    ...
    handleTriggerEvent: hostActions.handleTriggerEvent,
