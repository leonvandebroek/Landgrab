...
9. Collect evidence at **phase boundaries only** (game start, end of each player's full turn, game end) using `evidence_checkpoint`. Do not capture screenshots, ARIA snapshots, or state snapshots after every individual action.
